...
const AdminAddShop = () => {
  ...
  const addShop = async (e) => {
    ...
    try {
      ...
      const formdata = {
        ...
        description,
        verified: true, // By default, shops added by admin are verified
      };
      const token = localStorage.getItem('authToken');
      await axios.post(`http://localhost:3001/api/admin/shops/Adminaddshop`, formdata, {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Add New Shop</h1>
